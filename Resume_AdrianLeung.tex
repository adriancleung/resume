...
\begin{tabularx}{\textwidth\setlength{\extrarowheight}{5pt}}
  ...
  \\
  \textbf{Hardware Maintenance Summer Student} $\vert$ City of Edmonton   & May – August 2018      \\
  \multicolumn{2}{>{\hsize=\dimexpr2\hsize+2\tabcolsep+\arrayrulewidth\relax}X}
  {
    \begin{minipage}{0.85\paperwidth}
      \begin{compactList}
        \item Provide direct, one on one customer support in person, or over the phone to quickly identify and resolve customer computer problems
        \item Respond in a timely manner to incoming requests for customer service, and maintains contact with the end user to ensure the effectiveness of the solution
        \item Monitor and support audiovisual equipment in downtown City of Edmonton towers to ensure technology is working properly and customers are satisfied and feel supported
      \end{compactList}
    \end{minipage}
  }
\end{tabularx}
...
\begin{tabularx}{\textwidth\setlength{\extrarowheight}{5pt}}
  ...
  \vspace{-20pt}
  \begin{compactList}
    \item Re-developed a self-contained points and rewards gamificatio nmodule for the redesigned Resuce Food App
  \end{compactList}
  \vspace{-10pt}
